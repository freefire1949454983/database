...
public class Batchconfiguration {
	...
	@Autowired
	private JobBuilderFactory jobBuilderFactory;// This willl create Job
	
	@Autowired
	private StepBuilderFactory stepBuilderFactory; //This will create n number of batches
	...
	fieldExtractor.setNames(new String[]{"id","firstName","lastName","email","age"});
